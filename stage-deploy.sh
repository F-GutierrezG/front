...
ssh -o StrictHostKeyChecking=no ubuntu@${STAGE_SERVER} "docker run -d -p 80:3000 --name client-front --network client-front-network registry.gitlab.com/gusisoft/onelike/client/$FRONT:$TAG"
